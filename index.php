...
$ejercicios = [
  ...
  [
    ...
    "Ej 2: Factoriza" => "ejercicios/p7funciones/ej2factoriza.php",
    "Ej 1: Genera letra DNI" => "ejercicios/p7funciones/ej1dni.php",
  ...
  [
    ...
    "Ej 4: Variables" => "ejercicios/p2/ej4variables.php",
...
function crearLinks($temas)
{
  foreach ($temas as $titulo => $ejercicios) {
    ...
    foreach ($ejercicios as $ejercicio => $ruta) {
      echo '<p><a href="' . $ruta . '"target="_blank">' . $ejercicio . '</a></p>';
    }
    echo "</section>";
  }
}
